...
namespace UI
{
    public class UIManager : MonoBehaviour
    {
        ...
        private Text levelCountTxt;

        [SerializeField] private Text scoreTxt;
        [SerializeField] private Text attemptTxt;
        [SerializeField] private Text pushedObjectTxt;

        [Header("LevelFail UI")] [SerializeField]
        private GameObject levelFailObject;

        [SerializeField] private Button levelFailButton;

        [Header("Multiplier UI")] [SerializeField]
        private Text multiplierObjectTxt;
