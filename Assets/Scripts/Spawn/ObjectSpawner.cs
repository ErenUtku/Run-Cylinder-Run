...
namespace Spawn
{
    ...
    {
        [Header("EnemyObject")] [SerializeField]
        private GameObject[] enemyObject;

        [Header("CollectableObjects")] [SerializeField]
        ...
        private void Start()
        {
            spawnLocations = GetComponent<SpawnLocations>();
        }
        ...
        public void InstantiateObject(OBJECTTYPE type, LevelData leveldata)
        {
            ...
            for (int i = 0; i < multiplierCount; i++)
            {
                ...
                var spawnObject = Instantiate(selectedObject[selectedInt], selectedPoint.transform.position,
                    Quaternion.identity);
        ...
        private SpawnPoint SelectSpawnLocation()
        {
            ...
            foreach (var point in spawnLocations.spawnPoints)
            {
